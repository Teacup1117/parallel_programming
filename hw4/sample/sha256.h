...
// Device functions must be inline to avoid linking issues
#ifdef __CUDACC__

// K constants for SHA256 - define inline to avoid linker issues
__device__ static const WORD sha256_k[64] = {
...
__device__ __inline__ void sha256_transform_device(SHA256 *ctx, const BYTE *msg)
{
	...
	// Copy chunk into first 16 words - unrolled for better performance
	#pragma unroll
	...
	// Extend the first 16 words into the remaining 48 words - unrolled
	#pragma unroll
	for(i=16;i<64;++i)
	{
	...
	// Compress function main loop - correct SHA256 rotation
	for(i=0;i<64;++i)
	{
...
__device__ __inline__ void sha256_device(SHA256 *ctx, const BYTE *msg, size_t len)
{
