...
// Device functions - must be inline to be visible across compilation units
#ifdef __CUDACC__

// K constants for device functions - defined as static to avoid multiple definition
__device__ static const WORD d_k[64] = {
